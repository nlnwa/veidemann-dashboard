import {Directive, EventEmitter, Host, Inject, OnInit, Output} from '@angular/core';
...
export class QueryCrawlLogDirective extends QueryDirective<CrawlLogQuery, CrawlLog> implements OnInit {
